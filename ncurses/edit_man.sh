...
(*.[0-9]*)
	...
	if test ! -f "/home/kampr/dev/mini-shell-racoon/ncurses/man_alias.sed" ; then
cat >>/home/kampr/dev/mini-shell-racoon/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/kampr/dev/mini-shell-racoon/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/kampr/dev/mini-shell-racoon/ncurses/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/home/kampr/dev/mini-shell-racoon/ncurses/man_alias.sed" \
		< "$i" >$TMP
